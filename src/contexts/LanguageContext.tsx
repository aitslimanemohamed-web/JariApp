...
const translations = {
  fr: {
    ...
    feed: {
      ...
      filters: { all: "Tout", service: "Services", emploi: "Emplois", location: "Locations", vente: "Ventes", demande: "Demandes" },
  ...
  ar: {
    ...
    feed: {
      ...
      filters: { all: "الكل", service: "الخدمات", emploi: "الوظائف", location: "الإيجارات", vente: "البيع", demande: "الطلبات" },
  ...
  en: {
    ...
    feed: {
      ...
      filters: { all: "All", service: "Services", emploi: "Jobs", location: "Rentals", vente: "Sales", demande: "Requests" },
